...
class Log
{
    ...
    public function __construct(?int $IdRutatore, string $Method, string $Uri, ?string $Params, string $State, ?string $Error = null, ?string $Timestamp = null, ?int $Id = null)
    {
        $this->Id = $Id;
    ...
    public function setIdRutatore(int $IdRutatore)
    {
        $this->IdRutatore = $IdRutatore;
    }
    ...
    public function toArray(): array
    {
        return [
            'Id_Log' => $this->Id,
            'Id_Rutatore_Log' => $this->IdRutatore,
